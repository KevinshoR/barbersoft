...
export default function Hours() {
  ...
  return (
    <div>
      <p style={{ color: 'var(--cream-dim)', fontSize: 13, marginBottom: 20 }}>
        Define los días y horarios en que tu barbería atiende clientes.
      </p>

      <div style={{ background: 'var(--dark-2)', border: '1px solid var(--dark-4)', borderRadius: 12, overflow: 'hidden' }}>
          ...
          >
            ...
            >
              ...
              <input
                ...
                style={{ ...inp, opacity: hour.is_open ? 1 : 0.4, cursor: hour.is_open ? 'auto' : 'not-allowed', border: '1px solid ' + (rowError ? '#E8C97A' : 'var(--dark-4)') }}
              />
            ...
            {rowError && <p style={{ color: '#E8C97A', fontSize: 12, marginTop: 8, marginLeft: 152 }}>⚠ {rowError}</p>}
          </div>
          )
        })}
      </div>

      <div style={{ background: 'rgba(201,168,76,0.06)', border: '1px solid rgba(201,168,76,0.15)', borderRadius: 10, padding: '14px 20px', marginTop: 16 }}>
